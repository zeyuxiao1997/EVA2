...
# -*- encoding: utf-8 -*-
'''
@File    :   EventVFI_Mo6_Dy21.py
@Time    :   2021/07/08 20:22:20
@Author  :   Zeyu Xiao
@Version :   1.0
...
class EventVFI1(nn.Module):
    ...
    def __init__(self):
        ...
        ######################## Event+KPN #############################
        self.DynamicEventL3 = tmpModules2.DynamicEvent21(96, 96, 96)
        self.DynamicEventL2 = tmpModules2.DynamicEvent21(64, 64, 64)
        self.DynamicEventL1 = tmpModules2.DynamicEvent21(32, 32, 32)
...
class EventVFItest(nn.Module):
    """
    网络的模块细节见file文件处；
    这里encoder和decoder的feature连接为concat，用concat似乎更好
    """
    def __init__(self):
        super(EventVFItest, self).__init__()
    ...
    def forward(self, frame1):
        # encoder
        # sharing weights
        frame2=torch.rand(1,3,448,256)
        event_0_t=torch.rand(1,5,448,256)
        event_t_1 = torch.rand(1,5,448,256)
        frame1_L2 = F.interpolate(frame1, scale_factor=0.5, mode="bilinear")
        frame1_L3 = F.interpolate(frame1_L2, scale_factor=0.5, mode="bilinear")
