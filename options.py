...
parser.add_argument('--exp', type=str, default='/gdata2/xiaozy/Result', help='prefix of different dataset')
...
parser.add_argument('--saveStep', type=int, default=10000, help='input batch size')
